...
public interface ItemRepository extends JpaRepository<ItemModel, UUID> {
    ...
    @Query("select new " +
            ...
            "(im.id, im.nome, im.manualUso, im.descricao, im.imagemUrl, im.categoria, im.valorItem, im.valorGarantia, im.alugado, im.entregaFrete, im.entregaPessoal ) " +
    ...
    @Query("select new " +
            ...
            "(im.id, im.nome, im.categoria, im.descricao, im.imagemUrl, im.manualUso," +
